...
CREATE TABLE snmp.agents (hostname VARCHAR(500) PRIMARY KEY, version_snmp VARCHAR(10), port_snmp INT, community VARCHAR(500), status VARCHAR(10), initial_time INT,indice INT);
