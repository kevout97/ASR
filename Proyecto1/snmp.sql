...
CREATE TABLE snmp.devices (hostname VARCHAR(500) PRIMARY KEY, ip VARCHAR(50), version_so VARCHAR(100), interfaces INT,last_reboot VARCHAR(100),mac VARCHAR(100),info_admin VARCHAR(500));
